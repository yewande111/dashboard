            ...
            <div class="row">
                <div class="col-md-7" style="margin-left: 100px; margin-top: 30px">
                    <form method="post">
                        <?php
                            $id = $_GET['id'];
                            $query = mysqli_query($connect, "SELECT * from courses WHERE id= '{$id}'");
                        ...
                        <input type="text"   class="form-control" name="course_name" required value="<?php echo $fetch['course_name'] ?>">
                        <label> Instructor </label>
                        <input type="text" class="form-control" name="instructor" required value="<?php echo $fetch['instructor'] ?>"> <br>
                        ...
                        <input type="submit" name="update" value="Update" class="btn btn-info btn-lg">
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                $sql = mysqli_query($connect, "UPDATE courses SET course_name = '{$course_name}', instructor = '{$instructor}' WHERE id = '{$id}'") or die(mysqli_error($sql));
